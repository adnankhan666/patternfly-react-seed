...
import { TECHNICAL_PREVIEW_FEATURES } from '../../data/previewFeatures';
import {
  getInterestCount,
  hasVoted,
  toggleVote,
...
const TP_FEATURES = TECHNICAL_PREVIEW_FEATURES;
...
const TechnicalPreviewPage: React.FunctionComponent = () => {
  ...
  const selectedFeature = TP_FEATURES.find((f) => f.id === selectedFeatureId) ?? null;
              ...
              <FlexItem>
                ...
                <Content>
                  <p style={{ color: '#6b7280', margin: '4px 0 0', fontSize: '0.9rem' }}>
                    Explore technical preview capabilities, try related experiences, and share your interest
                  </p>
                </Content>
              </FlexItem>
